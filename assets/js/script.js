...
// Section 5 model js start
function model_1() {
     $("#model_1,#transition").css({
        'display' : 'block',
     });
}
function model_2() {
    $("#model_2,#transition").css({
       'display' : 'block'
    });
}
function model_3() {
    $("#model_3,#transition").css({
       'display' : 'block'
    });
}
function model_4() {
    $("#model_4,#transition").css({
       'display' : 'block'
    });
}
function model_5() {
    $("#model_5,#transition").css({
       'display' : 'block'
    });
}
function model_6() {
    $("#model_6,#transition").css({
       'display' : 'block'
    });
}
function model_7() {
    $("#model_7,#transition").css({
       'display' : 'block',
    });
}
function model_8() {
   $("#model_8,#transition").css({
      'display' : 'block'
   });
}
function model_9() {
   $("#model_9,#transition").css({
      'display' : 'block'
   });
}
function model_10() {
   $("#model_10,#transition").css({
      'display' : 'block'
   });
}
function model_11() {
   $("#model_11,#transition").css({
      'display' : 'block'
   });
}
function model_12() {
   $("#model_12,#transition").css({
      'display' : 'block'
   });
}

function close_model() {
    $("#model_1,#model_2,#model_3,#model_4,#model_5,#model_6,#model_7,#model_8,#model_9,#model_10,#model_11,#model_12, #transition").css({
        'display' : 'none',
    });
}


// Section 5 model js end
